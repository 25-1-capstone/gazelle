...
- Default configuration values for file paths and processing parameters
- Debug output intervals for performance monitoring
- COCO class labels for object detection (92 classes)
- Color schemes for visualization
- Detection thresholds for various models
"""
